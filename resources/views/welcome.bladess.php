...
<head>
    ...
    <style>
        * {
        ...
        /* Comet Section */
        .comet-section {
            background: linear-gradient(135deg, #9af1ea 0%, #7eff84 100%);
            color: white;
        }
...
<body>
    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <!-- Comet Section -->
            <section class="section comet-section bg-light">
                <div class="section-header">
                ...
                <div class="comet-grid">
                  ...
                  <a href="{{ route('game.show', $cometGame->slug) }}" class="game-link">
                        ...
                        <div class="comet-image"><img src="{{ asset('storage/' . $cometGame->thumbnail) }}" alt=""></div>
                    </div>
                </a>
                  @endforeach
                </div>
            ...
            <section class="section">
                ...
                <div class="game-grid">
                    <div class="game-card">
                        ...
                        <div class="game-info">
                            <div class="game-title">Merge a Fruit</div>
                            <div class="game-meta">Puzzle • Merge</div>
                        </div>
                    </div>
                    <div class="game-card">
                        <div class="game-image">🌙</div>
                        <div class="game-info">
                            <div class="game-title">99 Nights (Bloxd.io)</div>
                            <div class="game-meta">Multiplayer • Survival</div>
                        </div>
                    </div>
                    <div class="game-card">
                        <div class="game-image">
                        ...
                        <div class="game-info">
                            <div class="game-title">Obby: +1 Jump per Click</div>
                            <div class="game-meta">Casual • Clicker</div>
                        </div>
                    </div>
                    <div class="game-card">
                        <div class="game-image">
                        ...
                        <div class="game-info">
                            <div class="game-title">Dig out of Prison</div>
                            <div class="game-meta">Adventure • Escape</div>
                        </div>
                    </div>
                    <div class="game-card">
                        <div class="game-image">🐵</div>
                        <div class="game-info">
                            <div class="game-title">Crazy Zoo Monkey</div>
                            <div class="game-meta">Casual • Fun</div>
                        </div>
                    </div>
                </div>
            </section>
